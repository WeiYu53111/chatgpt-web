...
import VipPackage from "@/components/vip/VipPackage.vue";
	...
	<div class="bg-slate-50 py-4 dark:bg-slate-900">
		<div class="mx-auto max-w-7xl px-6 lg:px-8">
			<div class="mx-auto max-w-4xl text-center">
				<h2
					class="mt-20 text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-200 sm:text-5xl"
				>
					Pricing plans
				</h2>
...
<!--						<div class="flex text-xs font-semibold leading-5">
			...
			<div
				class="isolate mx-auto mt-14 grid max-w-md grid-cols-1 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-4"
			>
				<div
					...
					v-for="(data, index) in vipPackages" :key="index" >
					<div>
						...
						<p class="mt-6 flex items-baseline gap-x-1">
							<span class="text-5xl font-bold tracking-tight">${{data.price}}</span>
							<span
						...
						>
							<li class="flex gap-x-3" v-for="(line, index) in data.features" :key="index" >
								<svg
